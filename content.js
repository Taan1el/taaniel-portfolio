window.PORTFOLIO_CONTENT = {
  ...
  pages: {
    ...
    work: {
      ...
      archiveTitle: {
        et: "Veel t\u00f6id Fiizy praktikast.",
        en: "More work from my Fiizy internship.",
      },
      archiveText: {
        et: "Laiem valik kampaaniavisuaale, mille kallal praktika ajal t\u00f6\u00f6tasin.",
        en: "A wider selection of campaign visuals I worked on during the internship.",
      },
      archiveEmpty: {
      ...
      archiveItems: [
        { src: "assets/heros/Cozmo_v3.png", label: "Cozmo" },
        { src: "assets/heros/Credito365_Hero.png", label: "Credito365" },
        { src: "assets/heros/dineromon_summer_v1.png", label: "Dineromon" },
        { src: "assets/heros/Slana.png", label: "Slana" },
        { src: "assets/heros/SolcreditoREM.png", label: "Solcredito" },
        { src: "assets/heros/Vivus.png", label: "Vivus" },
      ],
    },
    about: {
      meta: {
